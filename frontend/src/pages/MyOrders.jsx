        ...
        {data.map((order,index)=>{
            return(
                <div key={index} className='grid grid-cols-3 lg:grid-cols-6  items-center border mb-4 pb-4 py-4 px-2  '>
                    ...
                    <button className='mx-4 md:mx-6 font-serif py-[6px] bg-red-100 text-xs md:text-sm rounded-sm hover:bg-red-400 hover:text-white cursor-pointer transition-all duration-300'>Track Order</button>
                </div>
            )
        })}
    </div>
